...
3. As instructed, fork the repository.
...
7. Click the green "Commit changes" button, which will write to a new branch in your fork of the repository.
9. Click the green "Propose changes" button. 
